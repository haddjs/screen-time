    ...
    <section id="apa-itu-screen-time" className="bg-white">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 py-12 md:py-20 px-6 md:px-16 xl:px-30">
        ...
        <div className="text-sm text-zinc-700">
          ...
          dini.
          <br /> <br />
          Teknologi memberikan banyak manfaat sebagai sarana hiburan, informasi,
          dan komunikasi. Namun, penggunaan gadget pada anak tetap memerlukan
          pengawasan serta pembatasan durasi agar tidak mengganggu proses tumbuh
          kembangnya.
        </div>
      </div>
